...
async def upstream(event):
    ...
    event = await edit_or_reply(event, f"ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - تحـديث ماتركس\n**•─────────────────•**\n\n**⪼ يتم تنصيب التحديث  انتظر 🌐 ،**")
    off_repo = "https://github.com/sedthon/kueb"
    os.chdir("/app")
    try:
        txt = (
    ...
    zzz1 = await event.edit(f"ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - تحـديث ماتركس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ماتركس .. انتظـر . . .🌐**")
    await asyncio.sleep(1)
    zzz2 = await zzz1.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - تحـديث ماتركس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ماتركس .. انتظـر . . .🌐**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz3 = await zzz2.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - تحـديث ماتركس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ماتركس .. انتظـر . . .🌐**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz4 = await zzz3.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - تحـديث ماتركس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ماتركس .. انتظـر . . .🌐**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz5 = await zzz4.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - تحـديث ماتركس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ماتركس .. انتظـر . . .🌐**\n\n%𝟺𝟶 ▬▬▬▬▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz6 = await zzz5.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ ⌁ - تحـديث ماتركس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ماتركس .. انتظـر . . .🌐**\n\n%𝟻𝟶 ▬▬▬▬▬▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz7 = await zzz6.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - تحـديث ماتركس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ماتركس .. انتظـر . . .🌐**\n\n%𝟼𝟶 ▬▬▬▬▬▬▭▭▭▭")
    await asyncio.sleep(1)
    zzz8 = await zzz7.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - تحـديث ماتركس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ماتركس .. انتظـر . . .🌐**\n\n%𝟽𝟶 ▬▬▬▬▬▬▬▭▭▭")
    await asyncio.sleep(1)
    zzz9 = await zzz8.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - تحـديث ماتركس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ماتركس .. انتظـر . . .🌐**\n\n%𝟾𝟶 ▬▬▬▬▬▬▬▬▭▭") 
    await asyncio.sleep(1)
    zzzz10 = await zzz9.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - تحـديث ماتركس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ماتركس .. انتظـر . . .🌐**\n\n%𝟿𝟶 ▬▬▬▬▬▬▬▬▬▭") 
    await asyncio.sleep(1)
    zzzz11 = await zzzz10.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - تحـديث ماتركس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ماتركس .. انتظـر . . .🌐**\n\n%𝟷𝟶𝟶 ▬▬▬▬▬▬▬▬▬▬💯") 
